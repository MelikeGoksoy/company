(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@melikeg/company', ['exports', '@angular/core', '@angular/common', '@angular/cdk/a11y', '@angular/cdk/drag-drop', '@angular/cdk/scrolling', '@angular/cdk/stepper', '@angular/cdk/table', '@angular/cdk/tree', '@angular/material', '@angular/animations', '@angular/common/http', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global.melikeg = global.melikeg || {}, global.melikeg.company = {}), global.ng.core, global.ng.common, global.ng.cdk.a11y, global.ng.cdk['drag-drop'], global.ng.cdk.scrolling, global.ng.cdk.stepper, global.ng.cdk.table, global.ng.cdk.tree, global.ng.material, global.ng.animations, global.ng.common.http, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var CompanyService = /** @class */ (function () {
        ...
        CompanyService.prototype.temp_getCompany = function (id) {
            return rxjs.from(companies).pipe(operators.delay(1));
        };
        CompanyService.prototype.temp_getCompany1 = function (id) {
            return rxjs.from(companies);
        };
...
//# sourceMappingURL=melikeg-company.umd.js.map
